...
import { deleteUserControl, loginControl, registerControl, updateUserControl } from '../auth/auth.controller.js'
import { authMiddleware } from '../middleware/auth.middleware.js'
import { allowRoles } from '../middleware/role.middleware.js'
import { getAllUsers, getUser } from '../auth/auth.service.js'
